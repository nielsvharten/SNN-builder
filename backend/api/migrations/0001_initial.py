...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='InputTrain',
            fields=[
                ('abstractnode_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='api.abstractnode')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('net', models.ForeignKey(default=None, on_delete=django.db.models.deletion.CASCADE, related_name='synapses', to='api.network')),
                ('post', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='incoming_synapses', to='api.abstractnode')),
                ('pre', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='outgoing_synapses', to='api.abstractnode')),
            ],
        ),
        migrations.AddField(
            model_name='abstractnode',
            name='net',
            field=models.ForeignKey(default=None, on_delete=django.db.models.deletion.CASCADE, related_name='nodes', to='api.network'),
        ),
    ]
